      ...
      _push(ssrRenderComponent(unref(Card), mergeProps({ class: "hero-card sb-fancy-card relative z-10 w-11/12 md:w-7/12 rounded-2xl bg-surface-800 -mt-16 md:mt-0 md:order-1" }, ssrGetDirectiveProps(_ctx, _directive_animateonscroll, heroCardAnimation)), {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</a><a href="https://www.linkedin.com/in/simone-b-bb6761200/" target="_blank" rel="noopener noreferrer" data-v-943e68ca${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Button), {
              icon: "pi pi-linkedin",
              severity: "secondary",
              text: "",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps(_ctx.$attrs, _attrs))} data-v-bf3592cb>`);
      ...
      ])}" data-v-bf3592cb><div class="${ssrRenderClass([{ "is-minimized": isMinimized.value }, "chat-window"])}" style="${ssrRenderStyle({ height: isMinimized.value ? "auto" : _ctx.chatHeight })}" data-v-bf3592cb><div class="chat-close-button" data-v-bf3592cb>`);
      _push(ssrRenderComponent(unref(Button), {
        class: "mr-2",
        icon: "pi pi-refresh",
        severity: "warn",
      ...
      _push(`</div><header class="chat-header" data-v-bf3592cb><span class="chat-title" data-v-bf3592cb>${ssrInterpolate(unref(t)("chat.title"))}</span>`);
      _push(ssrRenderComponent(unref(Button), {
      ...
      _push(`</header>`);
      if (!isMinimized.value) {
        _push(`<!--[--><div class="chat-history" data-v-bf3592cb><!--[-->`);
        ssrRenderList(messages.value, (msg) => {
          _push(`<div data-v-bf3592cb>`);
          if (msg.author === "user") {
        ...
        _push(`<!--]--></div><footer class="chat-footer" data-v-bf3592cb>`);
...
const Chat = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-bf3592cb"]]);
