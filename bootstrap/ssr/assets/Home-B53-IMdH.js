import { defineComponent, computed, ref, mergeProps, unref, withCtx, createVNode, createBlock, createCommentVNode, toDisplayString, openBlock, useSSRContext, reactive, watch, resolveDirective, Fragment, renderList, createTextVNode, withDirectives, nextTick } from "vue";
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "language-switcher" }, _attrs))} data-v-6b4baa74>`);
      ...
      _push(ssrRenderComponent(unref(Menu), {
        ...
        item: withCtx(({ item, props }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a${ssrRenderAttrs(mergeProps(props.action, { class: "flex align-items-center gap-2 w-full" }))} data-v-6b4baa74${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Image), {
              src: item.flagUrl,
              alt: item.lang + " flag",
              width: "18",
            ...
            _push2(`<span data-v-6b4baa74${_scopeId}>${ssrInterpolate(item.label)}</span>`);
            if (item.lang === unref(locale)) {
              _push2(`<i class="pi pi-check ml-auto" data-v-6b4baa74${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</a>`);
...
const LanguageSwitcher = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-6b4baa74"]]);
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative flex min-h-screen flex-col bg-surface-950" }, _attrs))}><div class="fixed top-0 left-0 right-0 z-20 flex items-center justify-between px-4 py-1 sm:px-6 bg-surface-950/80 backdrop-blur-sm border-surface-800"><div></div><div class="hidden sm:flex">`);
      _push(ssrRenderComponent(unref(Menubar), {
        key: menuKey.value,
        model: menuItems.value,
        pt
      }, null, _parent));
      _push(`</div><div class="flex items-center gap-2 sm:gap-3">`);
...
const Hero = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-7a0e1b70"]]);
...
const Skills = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-c63d8884"]]);
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_animateonscroll = resolveDirective("animateonscroll");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "px-4 py-16 sm:py-24" }, _attrs))} data-v-3c57c6a3><div class="container mx-auto max-w-6xl" data-v-3c57c6a3><div class="text-center mb-16" data-v-3c57c6a3><h2 class="text-3xl sm:text-4xl font-bold text-[var(--text-color)] mb-4" data-v-3c57c6a3>${ssrInterpolate(unref(t)("experience.sectionTitle"))}</h2></div>`);
      _push(ssrRenderComponent(unref(Timeline), {
        ...
        marker: withCtx((slotProps, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="marker-icon" style="${ssrRenderStyle({ backgroundColor: slotProps.item.color })}" data-v-3c57c6a3${_scopeId}><i class="${ssrRenderClass(slotProps.item.icon)}" data-v-3c57c6a3${_scopeId}></i></span>`);
          } else {
            return [
              createVNode("span", {
                class: "marker-icon",
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Card$1), mergeProps({ class: "experience-card mt-5" }, ssrGetDirectiveProps(_ctx, _directive_animateonscroll, experienceAnimation)), {
              ...
              subtitle: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="experience-subtitle" data-v-3c57c6a3${_scopeId2}><span class="company" data-v-3c57c6a3${_scopeId2}>${ssrInterpolate(unref(t)(slotProps.item.companyKey))}</span><span class="separator" data-v-3c57c6a3${_scopeId2}> | </span><span class="date" data-v-3c57c6a3${_scopeId2}>${ssrInterpolate(unref(t)(slotProps.item.dateKey))}</span></div>`);
              ...
              content: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<ul class="description-list" data-v-3c57c6a3${_scopeId2}><!--[-->`);
                  ssrRenderList(slotProps.item.descriptionKeys, (descKey) => {
                    _push3(`<li data-v-3c57c6a3${_scopeId2}>${ssrInterpolate(unref(t)(descKey))}</li>`);
                  });
                  _push3(`<!--]--></ul>`);
                } else {
                  return [
...
const Experience = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-3c57c6a3"]]);
...
const ChatBubble = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-bd4edc4a"]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "message-wrapper" }, _attrs))} data-v-71bdda78><div class="message-bubble" data-v-71bdda78><p class="message-content" data-v-71bdda78>${ssrInterpolate(_ctx.message.content)}</p></div></div>`);
    };
  }
});
...
const UserMessageBubble = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-71bdda78"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "message-wrapper" }, _attrs))} data-v-9b1d0054>`);
      _push(ssrRenderComponent(unref(Image), {
        src: unref(avatar),
        class: "w-8 h-8 rounded-full flex-shrink-0"
      }, null, _parent));
      _push(`<div class="${ssrRenderClass([{ "bubble-danger": _ctx.message.type === "error" }, "message-bubble"])}" data-v-9b1d0054>`);
      ...
      _push(`<p class="message-content" data-v-9b1d0054>${ssrInterpolate(_ctx.message.content)}</p></div></div>`);
    };
  }
});
...
const InterlocutorMessageBubble = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-9b1d0054"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["chat-window", { "is-minimized": isMinimized.value }],
        style: { height: isMinimized.value ? "auto" : _ctx.chatHeight }
      }, _attrs))} data-v-00fb2367><header class="chat-header" data-v-00fb2367><span class="chat-title" data-v-00fb2367>${ssrInterpolate(unref(t)("chat.title"))}</span>`);
      _push(ssrRenderComponent(unref(Button), {
        icon: isMinimized.value ? "pi pi-window-maximize" : "pi pi-window-minimize",
        severity: "secondary",
        text: "",
        rounded: "",
        onClick: ($event) => isMinimized.value = !isMinimized.value
      }, null, _parent));
      _push(ssrRenderComponent(unref(Button), {
        icon: "pi pi-times",
        severity: "secondary",
        text: "",
        rounded: "",
        onClick: ($event) => _ctx.$emit("close-chat")
      }, null, _parent));
      _push(`</header>`);
      if (!isMinimized.value) {
        _push(`<!--[--><div class="chat-history" data-v-00fb2367><!--[-->`);
        ssrRenderList(messages.value, (msg) => {
          _push(`<div data-v-00fb2367>`);
          if (msg.author === "user") {
        ...
        _push(`<!--]--></div><footer class="chat-footer" data-v-00fb2367>`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/components/custom/chat/ChatWindow.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const ChatWindow = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-00fb2367"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    windowBottom: { default: "2rem" },
    windowRight: { default: "2rem" },
    chatHistory: { default: () => [] }
  },
  setup(__props) {
    const props = __props;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-af03a4b7>`);
      if (!isChatOpen.value) {
        _push(ssrRenderComponent(ChatBubble, {
          class: "fixed-chat-element",
          style: { bottom: _ctx.bubbleBottom, right: _ctx.bubbleRight },
          onOpenChat: ($event) => isChatOpen.value = true
        }, null, _parent));
      } else {
        _push(ssrRenderComponent(ChatWindow, {
          class: "fixed-chat-element",
          style: { bottom: _ctx.windowBottom, right: _ctx.windowRight },
          "chat-history": props.chatHistory,
          onCloseChat: ($event) => isChatOpen.value = false
        }, null, _parent));
      }
      _push(`</div>`);
    };
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/components/custom/chat/ChatManager.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const ChatManager = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-af03a4b7"]]);
      ...
      _push(ssrRenderComponent(_sfc_main$9, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(ChatManager, {
