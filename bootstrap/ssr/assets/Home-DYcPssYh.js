...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-0eb6df09><header class="chat-header" data-v-0eb6df09><span class="chat-title" data-v-0eb6df09>${ssrInterpolate(unref(t)("chat.title"))}</span>`);
      _push(ssrRenderComponent(unref(Button), {
      ...
      if (!isMinimized.value) {
        _push(`<!--[--><div class="chat-history" data-v-0eb6df09><!--[-->`);
        ssrRenderList(messages.value, (msg) => {
          _push(`<div data-v-0eb6df09>`);
          if (msg.author === "user") {
        ...
        _push(`<!--]--></div><footer class="chat-footer" data-v-0eb6df09>`);
...
const ChatWindow = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-0eb6df09"]]);
