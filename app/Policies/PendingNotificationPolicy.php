...
class PendingNotificationPolicy
{
     ...
     */
    public function restore(User $user, PendingNotification $pendingNotification): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, PendingNotification $pendingNotification): bool
    {
        return false;
    }
}
