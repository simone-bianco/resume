...
return [
    ...
    |             ]
    */
    'chat_id' => env('TELEGRAM_CHAT_ID', 'YOUR-BOT-TOKEN'),
    //        'mySecondBot' => [
    //            'token' => '123456:abc',
    //        ],
    'bots' => [
        env('TELEGRAM_BOT_CODE', 'telegram_bot') => [
            'token' => env('TELEGRAM_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'username' => env('TELEGRAM_BOT_CODE', 'simone_bianco_resume_bot'),
            'webhook_url' => env('APP_URL') . '/api/telegram/webhook', // The URL to set the webhook for this bot.
    ...
    |
    */
    'default' => env('TELEGRAM_BOT_CODE', 'bot_default'),
