 ...
 *
 * @see \SimoneBianco\LaravelRules\Rules
 */
...
namespace SimoneBianco\LaravelRules {
    ...
    if (false) {
        /**
 * @method static \SimoneBianco\LaravelRules\Rules injectRuleForEmail(string[]|string|\Illuminate\Validation\Rule $rules) Injects a validation rule for the 'email' field.
 * @method static \SimoneBianco\LaravelRules\Rules injectRuleForName(string[]|string|\Illuminate\Validation\Rule $rules) Injects a validation rule for the 'name' field.
         */
        class Rules
        {
