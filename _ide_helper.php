...
namespace Stancl\Tenancy\Facades {
    ...
    class Tenancy {
        ...
        /**
         * @see \App\Features\CustomUserImpersonation::bootstrap()
         * @param \Stancl\Tenancy\Contracts\Tenant $tenant
         * @param string $userId
         * @param string $redirectUrl
         * @param string|null $impersonatorEmail
         * @param string|null $authGuard
         * @return \Stancl\Tenancy\Database\Models\ImpersonationToken
         * @static
         */
        public static function impersonate($tenant, $userId, $redirectUrl, $impersonatorEmail = null, $authGuard = null)
        {
            return \Stancl\Tenancy\Tenancy::impersonate($tenant, $userId, $redirectUrl, $impersonatorEmail, $authGuard);
        }
